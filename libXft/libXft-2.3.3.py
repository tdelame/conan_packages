...
class libXft(pyreq.BaseConanFile):
    description = 'X FreeType library'
    url = "https://www.x.org/"
    license = "X11"
    settings = "os"
    requires = ("libXrender/0.9.10@tdelame/stable", "freetype/2.9.1@tdelame/stable", "fontconfig/2.13.92@tdelame/stable")
