...
class boost_program_options(pyreq.BaseConanFile):
    description = "Boost Program Options library"
    ...
    def build(self):
        ...
        configure_command = "{bootstrap} --with-libraries={libraries_list}".format(
            ...
            libraries_list="program_options")
    ...
    def package_info(self):
        """Edit package info."""
        super(boost_program_options, self).package_info()
